    ...
    <div className="flex min-w-[300px] flex-col items-center gap-8 border-r border-solid border-accent bg-background p-8">
      ...
      <div className="flex w-full flex-col gap-3">
        ...
        <Link href="/dashboard/products">
          <Button
            variant="outline"
            className={`flex w-full justify-start gap-2 ${path.includes("/products") && "bg-primary text-white hover:bg-primary"}}`}
          >
            <PackageIcon size={16} />
            Produtos
          </Button>
        ...
        <Link href="/dashboard/orders">
          <Button
            variant="outline"
            className={`flex w-full justify-start gap-2 ${path.includes("/orders") && "bg-primary text-white hover:bg-primary"}}`}
          >
